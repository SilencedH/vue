        ...
        <v-layout row xs12 wrap>
          <v-flex xs12 md4>
            <v-radio-group v-model="alignment">
              <v-radio v-for="n in alignmentsAvailable" :key="n" :label="n === '' ? 'Nothing' : n" :value="n"></v-radio>
            </v-radio-group>
          </v-flex>
          <v-flex xs12 md4>
            <v-radio-group v-model="justify">
              <v-radio v-for="n in justifyAvailable" :key="n" :label="n === '' ? 'Nothing' : n" :value="n"></v-radio>
            </v-radio-group>
          </v-flex>
          <v-flex xs12 md4>
            <v-layout column>
              <v-radio-group v-model="flexDirection">
                ...
                <v-checkbox v-model="fillHeight" label="fill-height" hide-details></v-checkbox>
                <v-radio v-for="n in flexDirectionAvailable" :key="n" :label="n === '' ? 'Nothing' : n" :value="n"></v-radio>
              </v-radio-group>
            </v-layout>
          </v-flex>
        </v-layout>
